...
function makeConfig() {
    return __awaiter(this, void 0, void 0, function* () {
        const map = yaml.parse((0, core_1.getInput)('map', { required: true }));
        return exports.config.check({
            key: (0, core_1.getInput)('key', { required: true }),
            varName: (0, core_1.getInput)('var-name') || 'result',
            map,
        });
    });
}
...
const matcher_1 = __nccwpck_require__(4223);
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const config = yield (0, config_1.makeConfig)();
            const result = (0, matcher_1.matcher)(config.key, config.map);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.matcher = exports.isMatch = void 0;
const utils_1 = __nccwpck_require__(1314);
function isMatch(value, matchValue) {
...
function matcher(key, map) {
    ...
    (0, utils_1.invariant)(m, `did not find mapped value for ${key}`);
    return map[m];
}
